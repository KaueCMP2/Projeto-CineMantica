...
//         [HttpPost]
//         public  IActionResult validarCodigo(string email, string codigo)
//         {
...
//             var usasCod = _context.codigoUsuarioSenhas.Where(c => c.idUsuario == HttpContext.Session.GetInt32("idUser")).OrderByDescending(d => d.dataEnvio).FirstOrDefault();
//             if (usasCod == null)
//             {
//                 ViewBag.Modal = true;
...
//             if (usasCod.codigoSenha != Convert.ToInt32(codigo.ToString()))
//             {
//                 ViewBag.Modal = true;
//                 ViewBag.erro1 = "Dados invalidos";
//                 return View("Index");
